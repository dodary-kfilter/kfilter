...
const RULES=[
 ...
 ['시간',       t=>{ const s=['이 리포트는 5분 안에 완성되어야 합니다. 본문은 3,000자 안에서 씁니다.','검색은 결과를 읽는 데까지 한 번에 1분 남짓 걸립니다.'];
                   const b=['이 리포트는 후보 수와 관계없이 10분 안에 완성되어야 합니다. 본문은 6,000자 안에서 씁니다.','검색은 결과를 읽는 데까지 한 번에 1분 남짓 걸립니다.'];
 ...
 ['전개순서',   t=>/\n1\. (회사의 정체성과 구조|이 대상의 성격과 구성) — 과거와 현재\n2\. (그 구조에서 중요한 것|그 구성에서 흐름을 정하는 것) — 지금 판단을 가르는 요인\n3\. 그것의 현재 상태\n4\. 향후 전망 — (종목|대상)이 앞으로 어떻게 진행될지에 대한 본인의 판단\n5\. 결론 — 종합적 판단, 기대수익, 액션\n/.test(t)],

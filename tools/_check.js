...
const RULES=[
 ...
 ['잣대문구없음',  t=>!/얻을 것이 잃을 것보다|값을 부를|이 종목에 맞는 구성으로|절대PER과 동종|구분이 필요합니다|직접 확인이 필요합니다|재무제표 밖에 있는|자료에 없는 값은/.test(t)],
 ['검색문장',      t=>t.includes('전 종목의 자료를 한 번에') || t.includes('자료에 없는 사실은 지어내지 않습니다. 판단에 필요한 정보가 자료에 없다면 웹 검색을 한 차례 사용하여 확인하십시오.')],
];
